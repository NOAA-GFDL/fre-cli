...
@click.option(
    "-tf", "--test-failure", is_flag=True, default=False, help="Errors are only printed. Program will not exit."
)
@click.pass_context
...
@catalog_cli.command()
@click.option("--input", required=True, multiple=True, help="Catalog json files to be merged, space-separated")
@click.option("--output", required=True, nargs=1, help="Merged catalog")
@click.pass_context
