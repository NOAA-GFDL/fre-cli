...
CMOR_CREATES_DIR_BASE = "CMIP6/CMIP6/ISMIP6/PCMDI/PCMDI-test-1-0/piControl-withism/r3i1p1f1"
...
test_data = (
    (
        "/archive/ejs/CMIP7/ESM4/DEV/ESM4.5v01_om5b04_piC/gfdl.ncrc5-intel23-prod-openmp/pp/ocean_monthly/ts/monthly/5yr/",
        "Omon",
        "sos",
        "gn",
    ),
    (
        "/archive/Eric.Stofferahn/CMIP7/ESM4/DEV/ESM4.5v01_om5b04_piC/gfdl.ncrc5-intel23-prod-openmp/pp/land/ts/monthly/5yr/",
        "Lmon",
        "lai",
        "gr1",
    ),
    (
        "/archive/cm6/ESM4/DECK/ESM4_historical_D1/gfdl.ncrc4-intel16-prod-openmp/pp/atmos_scalar/ts/monthly/5yr/",
        "AERmonZ",
        "ta",
        "gr1",
    ),
    (
        "/archive/cm6/ESM4/DECK/ESM4_historical_D1/gfdl.ncrc4-intel16-prod-openmp/pp/LUmip_refined/ts/monthly/5yr/",
        "Omon",
        "so",
        "gr",
    ),
    (
        "/archive/cm6/ESM4/DECK/ESM4_historical_D1/gfdl.ncrc4-intel16-prod-openmp/pp/atmos_level_cmip/ts/monthly/5yr/",
        "Amon",
        "ch4global",
        "gr",
    ),
...
@pytest.mark.parametrize(
    "testfile_dir,table,opt_var_name,grid_label",
    [
        pytest.param(
            "/archive/ejs/CMIP7/ESM4/DEV/ESM4.5v01_om5b04_piC/gfdl.ncrc5-intel23-prod-openmp/pp/ocean_monthly/ts/monthly/5yr/",
            "Omon",
        ...
        pytest.param(
            "/archive/cm6/ESM4/DECK/ESM4_historical_D1/gfdl.ncrc4-intel16-prod-openmp/pp/atmos_plev39_cmip/ts/monthly/5yr/zonavg/",
            "AERmonZ",
            "ta",
            "gr1",
            id="AERmonZ_ta_gr1",
        ...
        pytest.param(
            "/archive/ejs/CMIP7/ESM4/DEV/ESM4.5v01_om5b04_piC/gfdl.ncrc5-intel23-prod-openmp/pp/ocean_monthly_z_1x1deg/ts/monthly/5yr/",
            "Omon",
            "so",
            "gr",
            id="Omon_so_gr",
...
def test_case_function(testfile_dir, table, opt_var_name, grid_label):
    ...
    if not Path(indir).exists():
        pytest.xfail(
            f"{opt_var_name}, {Path(table_file).name}, {grid_label} "
    ...
    # success criteria
    assert all([some_return == 0, Path(cmor_output_dir).exists(), Path(cmor_output_file).exists()])
