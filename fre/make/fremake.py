...
def run_fremake(yamlfile, platform, target, parallel, jobs, no_parallel_checkout, no_format_transfer, execute, verbose):
...
def create_dockerfile(yamlfile, platform, target, no_format_transfer, execute, force_dockerfile):
    """ - Write the dockerfile """
    create_docker_script.dockerfile_create(yamlfile, platform, target, no_format_transfer, execute, force_dockerfile)
