import click
from .createCheckout import _checkout_create
from .createCompile import _compile_create
from .createDocker import _dockerfile_create
from .createMakefile import _makefile_create
from .runFremake import _fremake_run
...
def create_checkout(context,yamlfile,platform,target,no_parallel_checkout,jobs,execute,verbose):
    ...
    context.forward(_checkout_create)
...
def create_makefile(context,yamlfile,platform,target):
    """ - Write the makefile """
    context.forward(_makefile_create)
...
def create_compile(context,yamlfile,platform,target,jobs,parallel,execute,verbose):
    ...
    context.forward(_compile_create)
...
def create_dockerfile(context,yamlfile,platform,target,execute):
    ...
    context.forward(_dockerfile_create)
