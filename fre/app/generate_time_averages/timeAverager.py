...
class timeAverager:
    ...
    def __repr__(self):
        ...
        return (
            f"{type(self).__name__}( pkg={self.pkg},                                unwgt={self.unwgt},                "
            f"                var={self.var},                                avg_type={self.avg_type})"
        )
    ...
    def var_has_time_units(self, an_nc_var=None):
        ...
        try:
            ...
            units_is_time = any(
                [
                    var_units == "seconds",
                    "seconds since" in var_units,
                    var_units == "minutes",
                    "minutes since" in var_units,
                    var_units == "hours",
                    "hours since" in var_units,
                    var_units == "days",
                    "days since" in var_units,
                    var_units == "months",
                    "months since" in var_units,
                    var_units == "years",
                    "years since" in var_units,
                ]
            )
