...
def test_generate_timavg_all_single_infile(mock_which, mock_popen):
    ...
    mock_which.return_value = '/not/a/real/path/timavg.csh'
    ...
    assert called_cmd == ['/not/a/real/path/timavg.csh', '-dmb', '-o',
...
def test_generate_timavg_all_multiple_infiles(mock_which, mock_popen):
    ...
    assert exitstatus == 0
    called_cmd = mock_popen.call_args[0][0]
    assert called_cmd == ['/not/a/real/path/timavg.csh', '-dmb', '-o', 'out.nc',
                           'a.nc', 'b.nc']
