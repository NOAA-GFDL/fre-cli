'''
setup routines for test_regrid_xy
'''
...
def cleanup():
    '''
    remove prev. generate files as needed
    '''
...
def make_grid_spec():
    '''
    makes a grid spec file via xarray dataset functionality
    '''
    xr.Dataset(
      data_vars = { "atm_mosaic_file" : f"{input_mosaic}".encode(),
