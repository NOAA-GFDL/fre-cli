...
@click.pass_context
def create_makefile(context,yamlfile,platform,target, verbose):
    """ - Write the makefile """
...
@click.option("-v", 
              ...
              help="Get verbose messages (repeat the option to increase verbosity level)")
@click.pass_context
def fremakefunction(context, yamlfile, platform, target, execute, parallel, jobs, no_parallel_checkout, submit, verbose):
    """
    - Execute fre make function
    """
    context.forward(fremake.fremake.testmake)
