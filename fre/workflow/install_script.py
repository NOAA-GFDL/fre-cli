...
def workflow_install(experiment):
    """
    ...
    :param experiment: Experiment names from the yaml displayed by fre list exps -y $yamlfile (e.g. c96L65_am5f4b4r0_amip), default None
    :type experiment: str
    """
...
#    workflow_name = make_workflow_name(experiment, platform, target)
    ...
    if os.path.isdir(install_dir):
        with change_directory(source_dir):
        ...
        fre_logger.warning(f"NOTE: About to install workflow into ~/cylc-run/{workflow_name}")
