...
@click.option("-e", "--experiment", type=str, help="Experiment name")
...
@click.option(
    "--use",
    type=click.Choice(["compile", "pp", "cmor"]),
    help="Process user is combining yamls for. Can pass 'compile', 'pp', or 'cmor'",
    required=True,
)
@click.option("-o", "--output", type=str, help="Output")
