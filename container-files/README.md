...
**If not on Gaea**, history file and grid spec data should be transferred to the `fre-cli-container-setup` location in:

- `fre-cli-container-setup/history/`
- `fre-cli-container-setup/[experiment]_grid/`
