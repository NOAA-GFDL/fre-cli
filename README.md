...
conda activate /nbhome/fms/conda/envs/fre-foo3
```
- Gaea:
```
module use /usw/conda/modulefiles
module load miniforge conda activate /ncrc/home2/fms/.conda/envs/fre-foo3
```
...
conda create --name fre-foo3 --channel noaa-gfdl --channel conda-forge fre-cli::foo3
conda activate fre-foo3
