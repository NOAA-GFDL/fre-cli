...
conda activate /nbhome/fms/conda/envs/fre-bar
```
- Gaea:
```
module use /usw/conda/modulefiles
module load miniforge conda activate /ncrc/home2/fms/.conda/envs/fre-bar
```
...
conda create --name fre-bar --channel noaa-gfdl --channel conda-forge fre-cli::bar
conda activate fre-bar
