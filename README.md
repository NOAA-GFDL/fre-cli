...
conda activate /nbhome/fms/conda/envs/fre-foo
```
- Gaea:
```
module use /usw/conda/modulefiles
module load miniforge conda activate /ncrc/home2/fms/.conda/envs/fre-foo
```
...
conda create --name fre-foo --channel noaa-gfdl --channel conda-forge fre-cli::foo
conda activate fre-foo
