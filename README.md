...
conda activate /nbhome/fms/conda/envs/fre-test-foo
```
- Gaea:
```
module use /usw/conda/modulefiles
module load miniforge conda activate /ncrc/home2/fms/.conda/envs/fre-test-foo
```
...
conda create --name fre-test-foo --channel noaa-gfdl --channel conda-forge fre-cli::test-foo
conda activate fre-test-foo
